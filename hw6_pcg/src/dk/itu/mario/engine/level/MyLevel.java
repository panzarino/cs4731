...
public class MyLevel extends Level{
	...
	public void create(MyDNA dna, int type)
	{
        ...
        for (int i = 0; i < chrome.length(); i++) {
            ...
            if (gene == 'a') {
                setBlock(i + STARTOFFSET, DEFAULTHEIGHT - 3, COIN);
            } else if (gene == 'b') {
                setBlock(i + STARTOFFSET, DEFAULTHEIGHT - 3, ROCK);
            } else if (gene == 'c') {
                setSpriteTemplate(i + STARTOFFSET, DEFAULTHEIGHT - 3, new SpriteTemplate(2, false));
            }
        }
